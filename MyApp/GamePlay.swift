        ...
        GeometryReader { geo in
            ZStack {
                Image("front_background")
                    ...
                    .overlay(Rectangle().foregroundStyle(.black.opacity(0.5)))
                        ...
                        VStack {
                            if animateViewsIn {
                                Image(systemName: "book.closed")
                                    ...
                                    .overlay (
                                        Image("kt\(game.currentQuestion.book)")
                                            .resizable()
                                            .scaledToFit()
                                            .padding(.trailing, 33)
                ...
                VStack {
                    ...
                    VStack {
                        if tappedCorrectAnswer {
                            ...
                            if game.answeredQuestions.count == game.filteredQuestions.count {
                                Button("Ferdig") {
                                    // End Game
                                    game.endGame()
                                    dismiss()
                                ...
                                Button("Neste >") {
                                    // TODO: Reste level for next question
